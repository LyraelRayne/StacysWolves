...
public class StacyWolves {
    ...
    public static final String VERSION  = "1.0.5-" + MC_VERSION;
    ...
    public static final String CREDITS = "Concepty by StacyPlays. Code by LyraelRayne and AKTheKnight. Artwork by Jaspanda and Nathan_Oneday of Walschaerts Build Team.";
