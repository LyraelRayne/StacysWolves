package au.lyrael.needsmoredragons.item;
...
import static au.lyrael.needsmoredragons.NeedsMoreDragons.CREATIVE_TAB;
import static au.lyrael.needsmoredragons.NeedsMoreDragons.MOD_ID;

public class ItemDragonPlacer extends ItemMonsterPlacer {
    ...
    public ItemDragonPlacer() {
        super();
    }

    public ItemDragonPlacer(String parEntityToSpawnName, int parPrimaryColor,
